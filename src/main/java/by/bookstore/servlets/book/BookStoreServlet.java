...
public class BookStoreServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Book> currentList = Dependencies.bookListHandlerService.getCurrentPage(currentPage,numValuesPage, connection);
        ...
        getServletContext().getRequestDispatcher("/book/bookStore.jsp").forward(req, resp);
    }
}
